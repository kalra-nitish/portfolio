...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="https://docs.google.com/document/d/1BAz1zdckisjZuCoDjkYyZAA7nZH9Gm7VeOVhNA3MyXg/edit?usp=sharing" variant="secondary" className="group mt-6 w-full">
        Download CV
